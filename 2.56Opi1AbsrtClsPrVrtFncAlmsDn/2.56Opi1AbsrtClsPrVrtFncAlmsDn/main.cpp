...
//Declare void attack function to override the virtual one in the base Enemy class outputting Ninja attack.
//CODE:
...
int main() {
	...
	//Instantiate object named n of the Ninja class.
	//CODE:
	...
	//Declare pointer enemy1 of class Enemy that holds the memory address of n
	//CODE:
	...
	//Call attack function using enemy1 (n) pointer and arrow member selection operator 
	//CODE:

	//Call the attack() function using enemy2 (m) pointer and arrow operator
	//CODE:

	//Call attack() through enemy3 pointer. Here will cause an error since orc has no implementation (commented out)
	//CODE:
