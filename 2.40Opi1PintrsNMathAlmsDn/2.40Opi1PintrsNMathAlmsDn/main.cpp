...
int main() {
	...
	//Declare uninitialized int claudia array with 5 elements.
	//CODE:
	...
	//Declare int pointer var named bpo initialized to memory address first element of claudia array.
	//CODE:

	//Declare int pointer named bpo1 initialized to memory address of second element of claudia array
	//CODE:

	//Declare for element 3 same way you did above.
	//CODE:

	cout << "\nBelow are the memory addresses of claudia/bp#\n";

	//Output memory addresses of bpo, bp0 and bpo2 to the screen.
	//CODE:
	...
	//Assign bp0 to increment operator ++.
	//CODE:

	//Output showing bp0 to screen
	//CODE:
