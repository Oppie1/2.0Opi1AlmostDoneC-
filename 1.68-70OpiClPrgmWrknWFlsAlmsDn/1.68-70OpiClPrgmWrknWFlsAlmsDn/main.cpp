...
//Declare an int function prototype "getWhatTheyWant()" with no parameters that will return user choice.
//Code:

//Declare void function prototype displayItems() with int variable as a parameter to the screen.
//CODE:
...
//CODE:
		...
		//have more that 0 power. Then add cout statement to display properly formatted information to the screen.
			...
			//Create while loop that brings power and name data from objectFile into local varss name and power for storage.
			//CODE:
