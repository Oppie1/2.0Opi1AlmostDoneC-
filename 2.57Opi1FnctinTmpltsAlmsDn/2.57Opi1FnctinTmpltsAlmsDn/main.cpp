...
//Declare template for the class Adam 
//CODE:

//Declare/Define function template named addTogether with return type Adam, parameters 
...
int main() {
	...
	//Call the addTogether function template with arguments x and y and ASSIGN the result to z.
	//CODE:
