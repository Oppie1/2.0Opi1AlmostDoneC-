...
int main() {
	...
	//Declare an uninitialized var named int answer.
	//CODE:
	...
	//Input user entry into num1 variable
	//CODE:
	...
	//Input user input and store it in num2
	//CODE:
	...
	//Assign var answer to expression num1/num2 and output to the screen.
	//CODE:

	//Use catch all block ... with output one cannot divide by 0.
	//CODE:
